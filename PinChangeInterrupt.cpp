...
//#include <wiring.h>              @onegulin
#include "wiring_private.h"     // @onegulin
#include <pins_arduino.h>
//#include <core_macros.h>         @onegulin

#include <avr/interrupt.h>
#include <avr/io.h>

#include "PinChangeInterrupt.h" // @onegulin 
#define MASK1(X) (1<<(X))       // @onegulin
...
tryAgain:
  ...
  if ( hole->callback == 0 )
  {
    ...
    hole->callback = callback;
      ...
      GIFR |= (1<<INTF0);       //Razg: clear interrupts
